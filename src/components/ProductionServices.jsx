      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-20 space-y-6">
          <div className="inline-block">
            <span className="px-4 py-2 bg-orange-500 bg-opacity-50 text-black rounded-full text-sm font-semibold border border-orange-500 border-opacity-30">
            ...
            return (
              ...
              >
                ...
                <div className={`relative h-full bg-white rounded-2xl p-6 sm:p-8 transition-all duration-500 transform ${
                  ...
                  {/* Number Badge */}
                  <div className="absolute top-6 right-6 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-sm font-bold text-gray-400 group-hover:bg-gradient-to-r group-hover:from-orange-500 group-hover:to-pink-500 group-hover:text-white transition-all duration-300">
                    {index + 1}
                  </div>
                </div>
              </div>
        ...
        <div className="text-center mt-16">
          <button className="group px-8 py-4 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold rounded-full shadow-lg hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 transform hover:scale-105">
