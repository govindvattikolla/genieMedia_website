        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-700 hover:bg-orange-500 flex items-center justify-center transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {company.map((item, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-300 hover:text-orange-500 transition-colors duration-200 inline-block">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+91 9966888428" className="text-gray-300 hover:text-orange-500 transition-colors duration-200">
                  +91 9966888428
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-orange-500 flex-shrink-0" />
                <a href="https://mailto:contact@kkdigitalgrowth.com" className="text-gray-300 hover:text-orange-500 transition-colors duration-200">
