...
import './Podcast.css'
import podVideo from '../assets/podcast/podcast_clip.mp4'
import mic from '../assets/podcast/podcast-mic.JPG'
import chair from '../assets/podcast/podcast-chair.JPG'
...
export default function PodcastStudio() {
  ...
  const openWhatsApp = () =>
    window.open("https://wa.me/917036426787", "_blank");
    ...
    <div>
      ...
      <section className="hero">
        <video autoPlay muted loop playsInline className="hero-bg-video">
          <source src={podVideo} type="video/mp4" />
        </video>
        ...
        <div className="hero-cta">
          <a href="https://wa.me/+917036426787" className="btn btn-primary">
            Book Studio
          </a>
        </div>
      </section>
      ...
      <section className="network-section" id="network">
        ...
        <div className="marquee-container">
          <div className="marquee-track">
            <img src={mic} alt="Podcast 1" />
            <img src={studioNyt} alt="Podcast 2" />
            <img src={setMIn} alt="Podcast 3" />
            <img src={light2} alt="Podcast 4" />
            <img src={cameras} alt="Podcast 5" />

            <img src={chair} alt="Podcast 1" />
            <img src={mic} alt="Podcast 3" />
            <img src={set2} alt="Podcast 4" />
          </div>
        </div>
      </section>
      ...
      <section className="furniture-section" id="equipment">
        ...
        <div className="furniture-container">
          <div className="furniture-item">
            <img src={set2} alt="Three seater sofa" />
            <p className="item-text">1 x complete podcast setup</p>
          </div>

          <div className="furniture-item">
            <img src={mic} alt="Two seater sofa" />
